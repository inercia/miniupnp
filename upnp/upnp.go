...
func Discover() (nat *UPnP, err error) {
...
func (n *UPnP) getExternalIPAddress() (info statusInfo, err error) {
...
func (n *UPnP) GetExternalAddress() (addr net.IP, err error) {
...
func (n *UPnP) AddPortMapping(protocol string, externalPort, internalPort int, description string, timeout int) (mappedExternalPort int, err error) {
...
func (n *UPnP) DeletePortMapping(protocol string, externalPort, internalPort int) (err error) {
